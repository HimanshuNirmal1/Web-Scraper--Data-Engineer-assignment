...
mycsv.writerow(['Parsing inside the individual pages of New York City, New York state, Los Angeles and California pages and displaying initial paragraph content: '])
for i in range(0,4):
    linkData = links[i];
